...
public class EditarTareaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teViTitulo.setText(intent.getStringExtra("titulo"));
        teViDescripcion.setText(intent.getStringExtra("descripcion"));
        teViEstado.setText(intent.getStringExtra("estado"));
